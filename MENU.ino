...
// Bu fonksiyon, ekranda sığabilen 2 menü öğesi oluşturacaktır. Menü boyunca ilerledikçe değişecekler. 
//Yukarı ve aşağı oklar geçerli menü konumunuzu gösterecektir.
void mainMenuDraw() {
...
// Çağrıldığında, bu işlev geçerli imleci silecek ve cursorPosition ve 
//menuPage değişkenlerine dayalı olarak yeniden çizecektir.
void drawCursor() {
  ...
  // Menü ileri gidecek olacak şekilde ayarlanmıştır (menuPage 0 = Öğe 1 ve Öğe 2, menü Sayfası 1 = Öğe 2 ve Öğe 3, menü 
  //Sayfası 2 = Öğe 3 ve Öğe 4), dolayısıyla
  // imlecin nerede olması gerektiğini belirlemek için tek veya çift menü sayfasında olup 
  //olmadığınızı ve tek veya çift imleç konumunu görmeniz gerekir
  if (menuPage % 2 == 0) {
...
// işleri biraz daha basitleştiren menüler. Birden fazla menü üzerinde ortak talimatlar veya işaretleriniz yoksa
// Bu boşluğu silebilirsiniz. Ayrıca, alt menü işlevlerinizden drawInstructions () işlev çağrılarını silmelisiniz.
void drawInstructions() {
  lcd.setCursor(0, 1); //İmleci alt çizgiye ayarla
  lcd.print("Use ");
  lcd.write(byte(1)); //Yukarı ok
  lcd.print("/");
  lcd.write(byte(2)); //Aşağı ok
  lcd.print(" buttons");
}
